...
**synchronisation_method**: The interval between synchronisations can be implemented as StartToStart or FinishToStart. If this value is not set, it will default to FinishToStart.
