...
BETA: **wecom_id**: Mandatory if notification_type set to 'WeCom'. This is the CORPID associated with your account.

BETA: **wecom_secret**: Mandatory if notification_type set to 'WeCom'. This is the CORPSECRET associated with your account.
